...
export const WOODS_CONFIG = {
	...
	greeting: [
		...
		{ text: "I specialize in analyzing the 'John Wood Group PLC Annual Report and Financial Statements 2023'." },
		{ text: "How can I help you extract data or analyze financial performance today?" }
	],
...
Your primary focus is the 'John Wood Group PLC Annual Report and Financial Statements 2023'.
...
3. **One Step at a Time:** If a user's request is complex, guide them through the analysis by providing clear, focused responses and asking for clarification if needed.
...
## Formatting Rule
Always present financial figures clearly. If you are citing a specific page or section mentioned in the context, do so to increase credibility.`,
